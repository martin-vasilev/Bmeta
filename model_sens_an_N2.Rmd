...
load('Summaries/N2/sum1_5.Rda'); load('Summaries/N2/sum2.Rda'); load('Summaries/N2/sum2_3.Rda')
load('Summaries/N2/sum2_4.Rda'); load('Summaries/N2/sum2_5.Rda'); load('Summaries/N2/sum3.Rda')
load('Summaries/N2/sum3_3.Rda'); load('Summaries/N2/sum3_4.Rda'); load('Summaries/N2/sum3_5.Rda')
load('Summaries/N2/sum4.Rda'); load('Summaries/N2/sum4_3.Rda'); load('Summaries/N2/sum4_4.Rda'); load('Summaries/N2/sum4_5.Rda'); load('Summaries/N2/sum5.Rda');load('Summaries/N2/sum5_3.Rda'); load('Summaries/N2/sum5_4.Rda'); load('Summaries/N2/sum5_5.Rda'); load('Summaries/N2/sum6.Rda'); load('Summaries/N2/sum6_3.Rda'); load('Summaries/N2/sum6_4.Rda'); load('Summaries/N2/sum6_5.Rda')
```
...
N+2 preview effects on word N+2 for all studies [FFD]
-----------------------------------------------------------------------------------------------------------
...
N(0, 0.001)      |Uniform(0,200)     |`r Mu2` (`r Mu2_SD`) [`r Mu2CI`] |`r Tau2` (`r Tau2_SD`) [`r Tau2CI`]|
Uniform(-200,200)|Gamma(0.001, 0.001)|`r Mu3` (`r Mu3_SD`) [`r Mu3CI`] |`r Tau3` (`r Tau3_SD`) [`r Tau3CI`]|
N(0, 0.001)      |Gamma(0.001, 0.001)|`r Mu4` (`r Mu4_SD`) [`r Mu4CI`] |`r Tau4` (`r Tau4_SD`) [`r Tau4CI`]|
...
N+2 preview effects on word N+2 only for alphabetical studies [FFD]
-----------------------------------------------------------------------------------------------------------
Prior on $\mu$   | Prior on $\tau$   | Posterior $\mu$ (SD) [95% CrI]  |Posterior $\tau$ (SD) [95% CrI]    |
-----------------|-----------------  |---------------------------------|-----------------------------------|
**Uniform(-200,200)**|**Uniform(0,200)**|`r Mu6` (`r Mu6_SD`) [`r Mu6CI`] |`r Tau6` (`r Tau6_SD`) [`r Tau6CI`]|
N(0, 0.001)      |Uniform(0,200)     |`r Mu7` (`r Mu7_SD`) [`r Mu7CI`] |`r Tau7` (`r Tau7_SD`) [`r Tau7CI`]|
Uniform(-200,200)|Gamma(0.001, 0.001)|`r Mu8` (`r Mu8_SD`) [`r Mu8CI`] |`r Tau8` (`r Tau8_SD`) [`r Tau8CI`]|
N(0, 0.001)      |Gamma(0.001, 0.001)|`r Mu9` (`r Mu9_SD`) [`r Mu9CI`] |`r Tau9` (`r Tau9_SD`) [`r Tau9CI`]|

*Note*: For Gamma distributions, the prior is on the precision (i.e. $1/\tau^2$). The priors in bold are the ones on which the results in the paper are based. 


N+2 preview effects on word N+2 for all studies [GD]
-----------------------------------------------------------------------------------------------------------
Prior on $\mu$   | Prior on $\tau$   | Posterior $\mu$ (SD) [95% CrI]  |Posterior $\tau$ (SD) [95% CrI]    |
-----------------|-----------------  |---------------------------------|-----------------------------------|
**Uniform(-200,200)**|**Uniform(0,200)**|`r Mu11` (`r Mu11_SD`) [`r Mu11CI`] |`r Tau11` (`r Tau11_SD`) [`r Tau11CI`]|
N(0, 0.001)      |Uniform(0,200)     |`r Mu12` (`r Mu12_SD`) [`r Mu12CI`] |`r Tau12` (`r Tau12_SD`) [`r Tau12CI`]|
Uniform(-200,200)|Gamma(0.001, 0.001)|`r Mu13` (`r Mu13_SD`) [`r Mu13CI`] |`r Tau13` (`r Tau13_SD`) [`r Tau13CI`]|
N(0, 0.001)      |Gamma(0.001, 0.001)|`r Mu14` (`r Mu14_SD`) [`r Mu14CI`] |`r Tau14` (`r Tau14_SD`) [`r Tau14CI`]|

*Note*: For Gamma distributions, the prior is on the precision (i.e. $1/\tau^2$). The priors in bold are the ones on which the results in the paper are based. 



N+2 preview effects on word N+2 only for alphabetical studies [GD]
-----------------------------------------------------------------------------------------------------------
Prior on $\mu$   | Prior on $\tau$   | Posterior $\mu$ (SD) [95% CrI]  |Posterior $\tau$ (SD) [95% CrI]    |
-----------------|-----------------  |---------------------------------|-----------------------------------|
**Uniform(-200,200)**|**Uniform(0,200)**|`r Mu16` (`r Mu16_SD`) [`r Mu16CI`] |`r Tau16` (`r Tau16_SD`) [`r Tau16CI`]|
N(0, 0.001)      |Uniform(0,200)     |`r Mu17` (`r Mu17_SD`) [`r Mu17CI`] |`r Tau17` (`r Tau17_SD`) [`r Tau17CI`]|
Uniform(-200,200)|Gamma(0.001, 0.001)|`r Mu18` (`r Mu18_SD`) [`r Mu18CI`] |`r Tau18` (`r Tau18_SD`) [`r Tau18CI`]|
N(0, 0.001)      |Gamma(0.001, 0.001)|`r Mu19` (`r Mu19_SD`) [`r Mu19CI`] |`r Tau19` (`r Tau19_SD`) [`r Tau19CI`]|

*Note*: For Gamma distributions, the prior is on the precision (i.e. $1/\tau^2$). The priors in bold are the ones on which the results in the paper are based. 


N+2 preview effects on word N+1 [FFD]
-----------------------------------------------------------------------------------------------------------
Prior on $\mu$   | Prior on $\tau$   | Posterior $\mu$ (SD) [95% CrI]  |Posterior $\tau$ (SD) [95% CrI]    |
-----------------|-----------------  |---------------------------------|-----------------------------------|
**Uniform(-200,200)**|**Uniform(0,200)**|`r Mu21` (`r Mu21_SD`) [`r Mu21CI`] |`r Tau21` (`r Tau21_SD`) [`r Tau21CI`]|
N(0, 0.001)      |Uniform(0,200)     |`r Mu22` (`r Mu22_SD`) [`r Mu22CI`] |`r Tau22` (`r Tau22_SD`) [`r Tau22CI`]|
Uniform(-200,200)|Gamma(0.001, 0.001)|`r Mu23` (`r Mu23_SD`) [`r Mu23CI`] |`r Tau23` (`r Tau23_SD`) [`r Tau23CI`]|
N(0, 0.001)      |Gamma(0.001, 0.001)|`r Mu24` (`r Mu24_SD`) [`r Mu24CI`] |`r Tau24` (`r Tau24_SD`) [`r Tau24CI`]|

*Note*: For Gamma distributions, the prior is on the precision (i.e. $1/\tau^2$). The priors in bold are the ones on which the results in the paper are based. 


N+2 preview effects on word N+1 [GD]
-----------------------------------------------------------------------------------------------------------
Prior on $\mu$   | Prior on $\tau$   | Posterior $\mu$ (SD) [95% CrI]  |Posterior $\tau$ (SD) [95% CrI]    |
-----------------|-----------------  |---------------------------------|-----------------------------------|
**Uniform(-200,200)**|**Uniform(0,200)**|`r Mu26` (`r Mu26_SD`) [`r Mu26CI`] |`r Tau26` (`r Tau26_SD`) [`r Tau26CI`]|
N(0, 0.001)      |Uniform(0,200)     |`r Mu27` (`r Mu27_SD`) [`r Mu27CI`] |`r Tau27` (`r Tau27_SD`) [`r Tau27CI`]|
Uniform(-200,200)|Gamma(0.001, 0.001)|`r Mu28` (`r Mu28_SD`) [`r Mu28CI`] |`r Tau28` (`r Tau28_SD`) [`r Tau28CI`]|
N(0, 0.001)      |Gamma(0.001, 0.001)|`r Mu29` (`r Mu29_SD`) [`r Mu29CI`] |`r Tau29` (`r Tau29_SD`) [`r Tau29CI`]|
