...
M1_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data1), "N2_M1.txt"),
                   data1, n.chains=3, n.adapt=3000, quiet=FALSE)
#M1_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data1), "N2_M1_2.txt"),
#                  data1, n.chains=3, n.adapt=3000, quiet=FALSE,
#                  inits= list("mu"=1, "tau"=5))
#M1_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dunif(0, 50)", nrow(data1), "N2_M1_3.txt"),
#                  data1, n.chains=3, n.adapt=3000, quiet=FALSE)
#M1_M <-jags.model(JModel("dunif(-50, 50)", "dgamma(5.0E-1, 5.0E-3)", nrow(data1), "N2_M1_4.txt"),
#                  data1, n.chains=3, n.adapt=3000, quiet=FALSE)
#M1_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dgamma(5.0E-1, 5.0E-3)", nrow(data1), "N2_M1_5.txt"),
#                  data1, n.chains=3, n.adapt=3000, quiet=FALSE)
...
M2_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data1a), "N2_M2.txt"),
                  data1a, n.chains=3, n.adapt=3000, quiet=FALSE)
#M2_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data1a), "N2_M2_2.txt"),
#                  data1a, n.chains=3, n.adapt=3000, quiet=FALSE,
#                  inits= list("mu"=1, "tau"=5))
#M2_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dunif(0, 50)", nrow(data1a), "N2_M2_3.txt"),
#                  data1a, n.chains=3, n.adapt=3000, quiet=FALSE)
#M2_M <-jags.model(JModel("dunif(-50, 50)", "dgamma(5.0E-1, 5.0E-3)", nrow(data1a), "N2_M2_4.txt"),
#                  data1a, n.chains=3, n.adapt=3000, quiet=FALSE)
#M2_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dgamma(5.0E-1, 5.0E-3)", nrow(data1a), "N2_M2_5.txt"),
#                  data1a, n.chains=3, n.adapt=3000, quiet=FALSE)
...
M3_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data2), "N2_M3.txt"),
                  data2, n.chains=3, n.adapt=3000, quiet=FALSE)
#M3_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data2), "N2_M3_2.txt"),
#                  data2, n.chains=3, n.adapt=3000, quiet=FALSE,
#                  inits= list("mu"=1, "tau"=5))
#M3_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dunif(0, 50)", nrow(data2), "N2_M3_3.txt"),
#                  data2, n.chains=3, n.adapt=3000, quiet=FALSE)
#M3_M <-jags.model(JModel("dunif(-50, 50)", "dgamma(5.0E-1, 5.0E-3)", nrow(data2), "N2_M3_4.txt"),
#                  data2, n.chains=3, n.adapt=3000, quiet=FALSE)
#M3_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dgamma(5.0E-1, 5.0E-3)", nrow(data2), "N2_M3_5.txt"),
#                  data2, n.chains=3, n.adapt=3000, quiet=FALSE)
...
M4_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data2a), "N2_M4.txt"),
                  data2a, n.chains=3, n.adapt=3000, quiet=FALSE)
#M4_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data2a), "N2_M4_2.txt"),
#                  data2a, n.chains=3, n.adapt=3000, quiet=FALSE,
#                  inits= list("mu"=10, "tau"=10))
#M4_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dunif(0, 50)", nrow(data2a), "N2_M4_3.txt"),
#                  data2a, n.chains=3, n.adapt=3000, quiet=FALSE)
#M4_M <-jags.model(JModel("dunif(-50, 50)", "dgamma(5.0E-1, 5.0E-3)", nrow(data2a), "N2_M4_4.txt"),
#                  data2a, n.chains=3, n.adapt=3000, quiet=FALSE)
#M4_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dgamma(5.0E-1, 5.0E-3)", nrow(data2a), "N2_M4_5.txt"),
#                  data2a, n.chains=3, n.adapt=3000, quiet=FALSE)
...
M5_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data3), "N2_M5.txt"),
                  data3, n.chains=3, n.adapt=3000, quiet=FALSE)
#M5_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data3), "N2_M5_2.txt"),
#                  data3, n.chains=3, n.adapt=3000, quiet=FALSE,
#                  inits= list("mu"=1, "tau"=5))
#M5_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dunif(0, 50)", nrow(data3), "N2_M5_3.txt"),
#                  data3, n.chains=3, n.adapt=3000, quiet=FALSE)
#M5_M <-jags.model(JModel("dunif(-50, 50)", "dgamma(5.0E-1, 5.0E-3)", nrow(data3), "N2_M5_4.txt"),
#                  data3, n.chains=3, n.adapt=3000, quiet=FALSE)
#M5_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dgamma(5.0E-1, 5.0E-3)", nrow(data3), "N2_M5_5.txt"),
#                  data3, n.chains=3, n.adapt=3000, quiet=FALSE)
...
M6_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data4), "N2_M6.txt"),
                  data4, n.chains=3, n.adapt=3000, quiet=FALSE)
#M6_M <-jags.model(JModel("dunif(-50, 50)", "dunif(0, 50)", nrow(data4), "N2_M6_2.txt"),
#                  data4, n.chains=3, n.adapt=3000, quiet=FALSE,
#                  inits= list("mu"=5, "tau"=10))
#M6_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dunif(0, 50)", nrow(data4), "N2_M6_3.txt"),
#                  data4, n.chains=3, n.adapt=3000, quiet=FALSE)
#M6_M <-jags.model(JModel("dunif(-50, 50)", "dgamma(5.0E-1, 5.0E-3)", nrow(data4), "N2_M6_4.txt"),
#                  data4, n.chains=3, n.adapt=3000, quiet=FALSE)
#M6_M <-jags.model(JModel("dnorm(0, 1.0E-3)", "dgamma(5.0E-1, 5.0E-3)", nrow(data4), "N2_M6_5.txt"),
#                  data4, n.chains=3, n.adapt=3000, quiet=FALSE)
