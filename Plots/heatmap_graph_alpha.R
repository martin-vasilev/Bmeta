...
colnames(db)<- c("y", "x", "Mean_difference", "Probability")
...
colnames(db2)<- c("y", "x", "Mean_difference", "Probability")
...
## FFD
Q3<- qplot(x=x, y=y, data=db, fill=Probability) + theme_bw()+ geom_tile(colour="#F0F4F5", size=1.2)+
  scale_fill_gradient2(limits=c(0, 1),
                       low= "white", mid="gray", high="darkblue") +xlab("")+
  ylab("")+ ggtitle("FFD")+
  theme(panel.grid.major = element_line(color="black", size=0.2),
        panel.grid.minor = element_blank(), panel.background = element_blank(),
        axis.line = element_line(colour = "black"),axis.title.x = element_text(size=24),
...
## GD
Q4<- qplot(x=x, y=y, data=db2, fill=Probability) + theme_bw()+ geom_tile(colour="#F0F4F5", size=1.2)+
  scale_fill_gradient2(limits=c(0,1),
                       low= "white", high="darkblue") +xlab("")+
  ylab("")+ ggtitle("GD")+
  theme(panel.grid.major = element_line(color="black", size=0.2),
        panel.grid.minor = element_blank(), panel.background = element_blank(),
        axis.line = element_line(colour = "black"),axis.title.x = element_text(size=24),
...
png(file = 'Plots/heat_Prob_FFD.png', width = 800, height = 800, units = "px")
Q3
dev.off()

png(file = 'Plots/heat_Prob_GD.png', width = 800, height = 800, units = "px")
Q4
dev.off()
