...
year[41]<- "0"
studies[26]<- "Rayner et al. (2014a)"
studies[29]<- "Hyönä et al. (2005)"
studies[31]<- "Yang et al. (2012a)"
...
studies[2]<- "Veldre et al. (2015a)"; studies[48]<- "Veldre et al. (2015b)"
studies[61]<- "Angele et al. (2013c)"; studies[49]<- "Angele et al. (2013c), Exp.2";
# observed:
obsM<- data$T
...
#  windows()
  ...
  # plot y grid
  for (i in 1:nrow(df)){
    segments(x0=start+step*i, y0=-70, x1=start+step*i, y1=maxY+35, lwd=1.2, lty=1, col="#E3E3E3")
  }
...
# pooled mean:
 ...
 #  legend:
  rect(xleft = (98.7/100)*maxX, ybottom = 58, xright = (95.7/100)*maxX, ytop = 135, lwd=1.2, lty = "solid", col="white") 
 #  observed:
  segments(x0=(96.5/100)*maxX, y0=62, x1=(96.5/100)*maxX, y1=74, lwd=1.2, lty=2, col="black")
  points(x= (96.5/100)*maxX, y=67.4, pch = 15, cex=1.3, col="white")
  points(x= (96.5/100)*maxX, y=67.4, pch = 0, cex=1.3, col="black")

 # posterior
  points(x= (97.8/100)*maxX, y=67.4, pch = 15, cex=1.3, col="darkred")
  segments(x0=(97.8/100)*maxX, y0=62, x1=(97.8/100)*maxX, y1=74, lwd=1.2, lty=1, col="darkred")
  
  # text:
  text(x=(97.8/100)*maxX, y=78, "Posterior (95% CrIs)", cex=1.2, font=2, srt = 90, adj=0)
  text(x=(96.5/100)*maxX, y=78, "Observed (95% CIs)", cex=1.2, font=2, srt = 90, adj=0)
